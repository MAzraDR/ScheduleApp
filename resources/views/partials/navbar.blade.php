...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('tasks.indexadmin')}}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Tasks Data</span></a>
            </li>
            @endif
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown me-4">
                            <a class="nav-link dropdown-toggle text-uppercase" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline fw-bold text-dark">{{session('userName')}}</span>
                            </a>
            ...
            $(document).on('click', '#delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        form.submit(); // Mengirimkan permintaan DELETE setelah pengguna mengkonfirmasi
                    }
                });
            })
        })
